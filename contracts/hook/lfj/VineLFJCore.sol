...
//         pair = ILBFactory(factory).createLBPair(
//             tokenX,
//             tokenY,
//             activeId,
//             binStep
...
//     function addLiquidity(addLiquidityParams memory params) external payable {
//         IERC20(params.tokenX).safeTransferFrom(
//             msg.sender,
//             address(this),
//             params.amountx
//         );
//         IERC20(params.tokenY).safeTransferFrom(
//             msg.sender,
//             address(this),
//             params.amounty
//         );
...
//         }
//         uint256[] memory newDistributionX = new uint256[](
//             params.distributionX.length
//         );
//         for (uint256 i = 0; i < params.distributionX.length; i++) {
//             newDistributionX[i] = params.distributionX[i];
//         }
//         uint256[] memory newDistributionY = new uint256[](
//             params.distributionY.length
//         );
...
//                 amountXMin: (params.amountx * (10000 - params.slippage)) /
//                     10000,
//                 amountYMin: (params.amounty * (10000 - params.slippage)) /
//                     10000,
//                 activeIdDesired: 0,
...
//         ) = ILBRouter(params.router).addLiquidity(liquidityParameters);
//         liquidityInfo[address(this)] = LiquidityInfo({
//             pair: params.pair,
...
//     //     LiquidityParameters memory params
...
//         ILBPair(liquidityInfo[address(this)].pair).approveForAll(
//             params.router,
//             true
//         );
